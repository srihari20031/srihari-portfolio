    ...
    <div className="flex flex-col items-center justify-center lg:my-40 md:my-28 max-sm:my-18 px-8">
      <div className="flex flex-col items-center justify-center gap-8">
        ...
        <h1 className="lg:text-2xl md:text-xl text-lg">
          Call to <span className="bg-gradient-to-r from-color-2 to-color-3 bg-clip-text text-transparent font-bold">Action</span>
        </h1>
      </div>
        ...
        {socialMediaLinks.map((socialMedia) => {
          return (
            <Link
              ...
              className=" text-black bg-white p-2 rounded-xl transform transition-transform duration-300 hover:scale-125 w-[48px] h-[48px] max-sm:w-[40px] max-sm:h-[40px] hover:shadow-custom-gold"
            >
